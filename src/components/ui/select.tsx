    ...
    return (
      <div className="w-full">
        ...
        <select
          ...
          style={{ backgroundColor: "#151B24", color: "#F0F6FC" }}
          {...props}
        >
          {placeholder && (
            <option value="" disabled style={{ backgroundColor: "#151B24", color: "#8B949E" }}>
              {placeholder}
            </option>
          )}
          {options.map((option) => (
            <option key={option.value} value={option.value} style={{ backgroundColor: "#151B24", color: "#F0F6FC" }}>
              {option.label}
            </option>
          ))}
        </select>
